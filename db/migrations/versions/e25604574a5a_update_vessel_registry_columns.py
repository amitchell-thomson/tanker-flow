...
def upgrade() -> None:
    op.add_column('vessel_registry', sa.Column('vf_vessel_type', sa.Text(), nullable=True))
    op.add_column('vessel_registry', sa.Column('year_built', sa.SmallInteger(), nullable=True))
    ...
    op.add_column('vessel_registry', sa.Column('gross_tonnage', sa.Integer(), nullable=True))
    op.add_column('vessel_registry', sa.Column('net_tonnage', sa.Integer(), nullable=True))
    op.add_column('vessel_registry', sa.Column('teu', sa.Integer(), nullable=True))
    op.add_column('vessel_registry', sa.Column('crude_capacity', sa.Integer(), nullable=True))
    op.add_column('vessel_registry', sa.Column('gas_capacity_m3', sa.Integer(), nullable=True))
    op.add_column('vessel_registry', sa.Column('is_lng_carrier', sa.Boolean(), nullable=True))
    op.add_column('vessel_registry', sa.Column('is_fsru', sa.Boolean(), nullable=True))
    op.add_column('vessel_registry', sa.Column('excluded', sa.Boolean(), nullable=False, server_default='false'))
    op.add_column('vessel_registry', sa.Column('exclusion_reason', sa.Text(), nullable=True))
    op.add_column('vessel_registry', sa.Column('vf_enrichment_status', sa.Text(), nullable=True))
